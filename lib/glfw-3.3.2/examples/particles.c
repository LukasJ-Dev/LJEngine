...
struct {
    ...
    int       p_frame;   // ParticleGenerator physics frame number
    int       d_frame;   // ParticleGenerator draw frame number
...
#define P_TEX_WIDTH  8    // ParticleGenerator texture dimensions
...
// ParticleGenerator texture (a simple spot)
...
//========================================================================
// ParticleGenerator system global variables
//========================================================================
...
//========================================================================
// WindowHandler resize callback function
//========================================================================
...
int main(int argc, char** argv)
{
    ...
    window = glfwCreateWindow(width, height, "ParticleGenerator Engine", monitor, NULL);
    if (!window)
    {
