...
static void window_pos_callback(GLFWwindow* window, int x, int y)
{
    ...
    printf("%08x to %i at %0.3f: WindowHandler position: %i %i\n",
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %0.3f: WindowHandler size: %i %i\n",
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %0.3f: WindowHandler content scale: %0.3f %0.3f\n",
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %0.3f: WindowHandler close\n",
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %0.3f: WindowHandler refresh\n",
           counter++, slot->number, glfwGetTime());
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %0.3f: WindowHandler %s\n",
           counter++, slot->number, glfwGetTime(),
...
{
    Slot* slot = glfwGetWindowUserPointer(window);
    printf("%08x to %i at %0.3f: WindowHandler was %s\n",
           counter++, slot->number, glfwGetTime(),
...
int main(int argc, char** argv)
{
    ...
    for (i = 0;  i < count;  i++)
    {
        ...
        snprintf(title, sizeof(title), "Event Linter (WindowHandler %i)", slots[i].number);
